...
export const BOOKMARKS: BookmarkSeed[] = [
  ...
  { title: "XCPC Rating", url: "https://hei-maom.github.io/xcpcrating/#/contests", icon: "bookmarks/xcpcrating.png" },
  { title: "XCPC Sight", url: "https://junjiecharles.github.io/xcpc-sight/", icon: "bookmarks/xcpc-sight.svg" },
  { title: "XCPC Link", url: "https://xcpc.link/", icon: "bookmarks/xcpc-link.svg" },
