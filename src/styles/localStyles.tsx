export default function LocalStyles() {
  return (
    <style>{`
      ...
      .bg-grid { opacity: 1; z-index: 0; }
      .app-root > .yc-atmosphere, .app-root > .grain { z-index: -1; }
      .content-rail { position: relative; z-index: 1; }
      .hero-status-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 110px), 1fr)); gap: 8px; }
      .hero-status .status-tile { padding: 10px; }
      .hero-status .status-content { min-height: 0; gap: 6px; }
      .bg-grid::before,
      .bg-grid::after {
        content: "";
        position: absolute;
      ...
      [data-theme="light"] .inner-elevated {
        ...
        border-color: rgba(126,108,82,0.30);
      }
      ...
      [data-theme="light"] .app-root [class*="border-white/10"] { border-color: rgba(15,23,42,0.26); }
      [data-theme="light"] .app-root [class*="border-white/5"] { border-color: rgba(15,23,42,0.16); }
      ...
      .app-root .download-route-card {
        color: var(--yc-text);
      }

      [data-theme="light"] .app-root .download-route-card {
        border-color: rgba(180,160,130,0.56);
        background: rgba(253,248,238,0.84);
        color: #111827;
      }

      [data-theme="light"] .app-root .download-route-card .download-route-action {
        border-color: rgba(126,108,82,0.38);
        background: rgba(245,235,218,0.86);
        color: #111827;
      }

      [data-theme="light"] .app-root .download-route-card .download-route-action:hover {
        border-color: rgba(126,108,82,0.62);
        background: rgba(232,223,208,0.96);
        color: #111827;
      }

      [data-theme="light"] .app-root .download-route-card .download-route-meta {
        color: #374151;
      }
      ...
      [data-theme="light"] .app-root .top-bar-separator {
        ...
        filter:
          drop-shadow(0 0 6px rgba(245,213,150,0.58))
          drop-shadow(0 0 14px rgba(138,91,18,0.24));
      }

      [data-theme=light] .app-root .breathing-separator-horizontal {
        background-image: linear-gradient(
          to right,
          rgba(138,91,18,0),
          rgba(138,91,18,0.92),
      ...
      @keyframes separatorBreath {
        0%, 100% {
          ...
          transform: scaleX(1);
          filter:
            drop-shadow(0 0 7px rgba(245,213,150,0.42))
            drop-shadow(0 0 0 rgba(138,91,18,0));
        }
        50% {
          opacity: 1;
          transform: scaleX(1.55);
          filter:
            drop-shadow(0 0 18px rgba(245,213,150,0.88))
            drop-shadow(0 0 42px rgba(138,91,18,0.30));
          }
      }

      @keyframes separatorBreathHorizontal {
        0%, 100% {
          opacity: 0.58;
          transform: scaleY(1);
          filter:
      ...
      [data-theme=light] .app-root .breathing-separator {
        animation: separatorBreath 3.2s ease-in-out infinite;
      }

      [data-theme=light] .app-root .breathing-separator-horizontal {
        animation-name: separatorBreathHorizontal;
      }
      ...
      [data-theme=dark] .app-root .breathing-separator-horizontal {
        background-image: linear-gradient(
          to right,
          rgba(88,199,255,0),
          rgba(210,244,255,0.88),
      ...
      @keyframes separatorBreathDarkHorizontal {
        0%, 100% {
          opacity: 0.55;
          transform: scaleY(1);
          filter:
      ...
      [data-theme=dark] .app-root .breathing-separator {
        animation: separatorBreathDark 3.2s ease-in-out infinite;
      }

      [data-theme=dark] .app-root .breathing-separator-horizontal {
        animation-name: separatorBreathDarkHorizontal;
      }
      ...
      [data-theme="dark"] .app-root .project-card:hover {
        ...
        box-shadow: var(--yc-shadow-interactive);
      }
      ...
      .status-dot-neutral { color: rgba(160,176,191,0.64); }
      .status-dot-accent { color: rgba(88,199,255,0.92); }
      .status-dot-warm { color: rgba(255,184,107,0.92); }
      .status-dot-success { color: rgba(152,239,186,0.92); }
      ...
      [data-theme="light"] .app-root .status-dot {
        width: 0.4375rem;
        height: 0.4375rem;
        border: 1px solid rgba(255,255,255,0.82);
        background-color: rgba(95,84,68,0.42);
        box-shadow:
          0 0 0 2px rgba(180,160,130,0.14),
          inset 0 0 0 1px rgba(126,108,82,0.16);
      }

      [data-theme="light"] .app-root .status-dot-neutral {
        background-color: rgba(101,112,125,0.34);
        box-shadow:
          0 0 0 2px rgba(101,112,125,0.10),
          inset 0 0 0 1px rgba(101,112,125,0.14);
      }

      [data-theme="light"] .app-root .status-dot-accent {
        background-color: rgba(61,93,99,0.42);
        box-shadow:
          0 0 0 2px rgba(91,167,186,0.10),
          inset 0 0 0 1px rgba(49,82,88,0.16);
      }

      [data-theme="light"] .app-root .status-dot-warm {
        background-color: rgba(129,93,48,0.40);
        box-shadow:
          0 0 0 2px rgba(191,139,68,0.12),
          inset 0 0 0 1px rgba(129,93,48,0.16);
      }

      [data-theme="light"] .app-root .status-dot-success {
        background-color: rgba(64,101,75,0.40);
        box-shadow:
          0 0 0 2px rgba(80,135,92,0.10),
          inset 0 0 0 1px rgba(64,101,75,0.16);
      }
      ...
      .app-root .bookmarks-panel {
        box-shadow: var(--yc-shadow-floating);
      }
      ...
      .app-root .sidebar-item-card {
        transition: transform 140ms ease, background 160ms ease, box-shadow 220ms ease;
      }

      .app-root .sidebar-item-card:hover {
        transform: translateY(-1px);
        background: rgba(255,255,255,0.075);
        box-shadow: var(--yc-shadow-compact-interactive);
      }
